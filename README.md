...
<head>
    ...
    <style>
        ...
        .highlight {
            background-color: rgb(141, 37, 226);
        }
...
<body>
    <!-- Header with Logo -->
    <div class="logo">
        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRKZfSj21lL4B0AeATFHKdFuH5NiLSknduUDg&s" width="1000" height="200">
        <h3>SLOT TIMETABLE S.VASUNTHARA SAI(24009011)</h3>
    </div>
...
```
# OUTPUT
![image](https://github.com/user-attachments/assets/e929cac0-cdf2-4c1b-9225-315d726c09ae)


![alt text](<Screenshot 2024-12-08 101033-1.png>)
